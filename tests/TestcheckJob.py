...
self_url = 'https://westeurope.cris.ai/api/speechtotext/v3.0/transcriptions/ccb2b6ef-34e8-430c-a4ca-86d39726a3db'
subscription_key = get_secret_from_key_vault("https://vault57765.vault.azure.net/" , "speechkey")
